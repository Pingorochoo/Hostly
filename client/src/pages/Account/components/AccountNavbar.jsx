...
const AccountNavbar = ({ subpage }) => {
  ...
  return (
    <nav className="w-full flex justify-center my-4 md:my-8 gap-2">
      ...
      <Link className={navClasses("bookings")} to={"/account/bookings"}>
        ...
        <span className="text-sm md:text-base">Trips</span>
      </Link>
      <Link className={navClasses("places")} to="/account/places">
        ...
        <span className="text-sm md:text-base">Spaces</span>
      </Link>
    </nav>
  );
};
