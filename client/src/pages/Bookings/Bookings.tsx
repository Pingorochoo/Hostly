...
const Bookings = () => {
  ...
  const fetchUserBookings = useCallback(async () => {
    try {
      ...
      const { data } = await axios.get<BookingType[]>("/booking/user");
    ...
    <div>
      ...
      {bookings.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-4">
          {bookings.map(({ _id, place, checkOutDate, checkInDate }) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 p-4 md:p-6 flex flex-col gap-3 md:gap-4">
                  <div>
                    <h2 className="text-lg md:text-xl font-medium text-gray-900 mb-1 line-clamp-1">
                      {place.title}
                    </h2>
                    <p className="text-gray-500 text-sm md:text-base line-clamp-1">
                      {place.address}
                    </p>
                  </div>
